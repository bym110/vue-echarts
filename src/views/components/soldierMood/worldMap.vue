                                ...
                                areaStyle: {
                                    normal:{
                                        color: { // 颜色线性渐变
                                            ...
                                            y2: 1,
                                            colorStops: [
                                                     {offset: 0, color: 'rgba(234,40,66,.8)'},
                                                    {offset: 0.5, color: 'rgba(234,40,66,.5)'},
                                                    {offset: 1, color: 'rgba(234,40,66,.1)'}
                                            ],
                                            globalCoord: false // 缺省为 false
                                        }
