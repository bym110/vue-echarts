            ...
            <Col span="8">
                <div class="list">
                    <div class="right">
                        ...
                        <span class="angle4"></span>
                        <div class="chart-32">
                            <radar-chart ref="chart6" id="right_1" title='各部门好友数量对比' :data="friendRadarData"></radar-chart>
                        </div>
                        <div class="chart-68">
                            <double-bar-chart ref="chart7" id="right_2"></double-bar-chart>
                        </div>
                ...
                <div class="list">
                    <div class="right">
                        ...
                        <span class="angle4"></span>
                         <div class="chart-32">
                            <radar-chart ref="chart8" id="right_3" title='各部门朋友圈数量对比' :data="momentsRadarData"></radar-chart>
                        </div>
                        <div class="chart-68">
                            <single-area-chart ref="chart9" id="right_4"></single-area-chart>
                        </div>
                    </div>
                </div>
            ...
            <Col span="16">
                <div class="list">
                    <div class="bottom">
                        ...
                        <span class="angle3"></span>
                        <span class="angle4"></span>
                       <double-line ref="chart10" id="bottom_1"></double-line>
                    </div>
                </div>
                <div class="list">
                    <div class="bottom">
                        ...
                        <span class="angle3"></span>
                        <span class="angle4"></span>
                        <double-bars ref="chart12" id="bottom_2"></double-bars>
                    </div>
                </div>
                <div class="list">
                    <div class="bottom">
                        ...
                        <span class="angle3"></span>
                        <span class="angle4"></span>
                        <three-bar-chart ref="chart5" id="bottom_3"></three-bar-chart>
                    </div>
                </div>
            </Col>
            <Col span="8">
                <div class="list right-bottom">
                    <div class="bottom bottom1">
                        ...
                        <span class="angle3"></span>
                        <span class="angle4"></span>
                        <pie-chart ref="chart11" id="bottom_4"></pie-chart>
                    </div>
                </div>
            </Col>
        </Row>
                ...
                let  context = $("#main").get(0).getContext('2d');
                  ...
                  //外圆
                   ...
                   var y = 240 * Math.sin(everyPer);
                    ...
                    context.restore();
                    // context.fillStyle = "#09102E";
                    // context.beginPath();
                    // context.arc(this.circle.x,this.circle.y, 120, 0, 2*Math.PI, true);
                    // context.closePath();
                    // context.fill();
                    // context.restore();
